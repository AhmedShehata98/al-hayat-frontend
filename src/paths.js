export const paths = {
  ...
  dashboard: {
    ...
    policy: {
      index: "/dashboard/terms-of-use",
      termsOfUse: "/dashboard/policy/terms-of-use",
      privacyPolicy: "/dashboard/policy/privacy-policy",
    },
    aboutUs: {
      index: "/dashboard/about-us",
    },
    ...
    mail: "/dashboard/mail",
    orderSchedule: { index: "/dashboard/order-schedule" },
    orders: {
    ...
    products: {
      ...
      createDescription: "/dashboard/products/create-description",
    },
    offers: {
      discountList: "/dashboard/offers",
      couponList: "/dashboard/offers/coupons",
      createDiscount: "/dashboard/offers/create-discount",
      createCoupon: "/dashboard/offers/create-coupon",
    },
    categories: {
      index: "/dashboard/categories",
      create: "/dashboard/categories/create-category",
    },
    cars: {
