...
const Page = () => {
  ...
  const tabs = [
    { label: customerTranslation.detailsPage.tabs.details, value: "details" },
  ];
  usePageView();
            ...
            <Stack spacing={4}>
              <div>
                ...
                >
                  ...
                  <Typography variant="subtitle2">
                    {customerTranslation.detailsPage.header.goBack}
                  </Typography>
                </Link>
              </div>
              <Stack
              ...
              >
                <Stack alignItems="center" direction="row" spacing={2}>
                  ...
                  <Stack spacing={1}>
                    ...
                    <Stack alignItems="center" direction="row" spacing={1}>
                      <Typography variant="subtitle2">
                        {customerTranslation.detailsPage.header.userId}:
                      </Typography>
                ...
                <Stack alignItems="center" direction="row" spacing={2}>
                  ...
                  >
                    {customerTranslation.detailsPage.header.editBtn}
                  </Button>
                  <Button
                    endIcon={
                      <SvgIcon>
                    ...
                    variant="contained"
                  >
                    {customerTranslation.detailsPage.header.ctaBtn}
                  </Button>
                </Stack>
              </Stack>
              <div>
